...
const Banner = () => {
  return (
    ...
    <span id="about"></span>
      <div style={bgImage}>
        <div className="container min-h-[550px] flex justify-center items-center py-12 sm:grid-cols-2">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
              ...
              className="text-sm text-gray-500 tracking-wide leading-5">
                ...
                reiciendis inventore iste ex alias quis magni at optio
              </p>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div data-aos="fade-left"
                 className="space-y-3 border-l-4 border-primary/50 pl-6">
                    ...
                    <p className="text-gray-500 text-sm">Much like writing code, brewing the perfect cup of tea
