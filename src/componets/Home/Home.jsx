...
const Home = () => {
  return (
    <div
      className="min-h-[550px] sm:min-h-[600px] bg-brandDark flex 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2">
          ...
          <div className="order-1 sm:order-2">
            ...
            <div data-aos="fade-up" data-aos-delay="300">
              ...
              to-secondary border-2 border-primary rounded-full px-4 py-2
          ...
          >
            ...
            <div data-aos="fade-left"
             ...
             absolute top-12 left-12 p-3 rounded-xl"
            >
              <h1>Hey Coder</h1>
            </div>
            <div data-aos="fade-right"
              className="bg-gradient-to-r from-primary to-secondary
             absolute bottom-12 right-12 p-3 rounded-xl"
            >
              <h1>Best Coffee</h1>
            </div>
          </div>
